    ...
    <div class="col-md-4" style="display: block; background-color: rgba(255, 255, 255, 0.4);">
        <div style="text-align:center;">
            ...
            <form action="#" method="post">
                <button id="btn" name="pregled" class="btn btn-default" onclick="prikazi()"><img src="image/view.png" style="width: 25px;height: 25px;"></button>
            </form>
        </div>
        ...
        <div style="text-align:center;">
            <h3>Izbrisi tim</h3>
            <button id="btn-obrisi" class="btn" data-toggle="modal" data-target="#obrisiModal"><img src="image/delete.png" style="width: 25px;height: 25px;"></button>
        </div>
        <div style="text-align:center;">
            <h3>Sortiraj po imenu</h3>
            <form action="#" method="post">
                <button id="btn-izmeni" name="sort" class="btn"><img src="image/sort.png" style="width: 25px;height: 25px;"></button>
            </form>
        </div>
        <br>
    </div>
    ...
    <div class="modal fade" id="obrisiModal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container tim-form">
                        <form action="handler/delete.php" method="post" id="obrisiForm">
                            <h3 style="color: black">Brisanje</h3>
                            <div class="form-group">
                                <div class="form-group">
                                    <input id="obrisi-idd" type="text" name="timID" class="form-control" placeholder="Id tima *" value="" />
                                </div>

                                <button id="btnObrisi" type="submit" class="btn btn-success btn-block" style="color: white; background-color: orange; border: 1px solid white"><i class="glyphicon glyphicon-pencil"></i> Obrisi tim
                                </button>
                            </div>
